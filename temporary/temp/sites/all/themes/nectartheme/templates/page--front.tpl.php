...
<div id="top" class="container wrapper">
	<div id="header" class="span-12 last">
		...
		<div id="logo" class="span-12 last">
			<img src="<?php print base_path(); ?><?php print path_to_theme(); ?>/images/nectarlogo.jpg" />
			<img src="<?php print base_path(); ?><?php print path_to_theme(); ?>/images/vmbar.jpg" />
		</div>
		...
		<div id="main" class="span-12 last">
			...
			<div id="page-bottom" class="region clearfix">
